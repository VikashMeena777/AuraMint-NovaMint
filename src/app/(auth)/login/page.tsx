...
export default function LoginPage() {
  return (
    <Suspense fallback={
      <div className="glass noise relative mx-auto w-full max-w-sm p-7 animate-pulse">
        <div className="h-9 w-36 rounded bg-muted mb-6" />
        <div className="h-12 w-full rounded-xl bg-muted mb-4" />
